                ...
                <form action="/tp3/index.php/Admin/Shop/shop_update" method="post">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="shop_id" value="<?php echo ($shop_info[0]['id']); ?>" />
                            <div class="input-group">
                                <span class="input-group-addon">门店名称</span>
                                <input type="text" name="shop_name" class="form-control"  value="<?php echo ($shop_info[0]['shop_name']); ?>" required="required" />
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon">门店说明</span>
                                <input type="text" name="desc" class="form-control" value="<?php echo ($shop_info[0]['desc']); ?>" required="required" />
                            </div>                    
                            <div class="input-group">
                                <span class="input-group-addon">门店地址</span>
                                <input type="text" name="address" class="form-control" value="<?php echo ($shop_info[0]['address']); ?>" required="required" />
                            </div>
                     
                            <div class="input-group" >
                                <span class="input-group-addon">联系手机</span>
                                <input type="text" name="tel" class="form-control" value="<?php echo ($shop_info[0]['tel']); ?>" required="required" />
                            </div>
                            <div class="input-group" >
                                <span class="input-group-addon">门店坐标</span>
                                <input type="text" name="lnglat" class="form-control" value="<?php echo ($shop_info[0]['lng']); ?>,<?php echo ($shop_info[0]['lat']); ?>" required="required" />
                            </div>  
