                ...
                <div class="panel-body">
                    ...
                    <div class="input-group">
                        ...
                        <select id="type1" name="type1" class="form-control" required="required" placeholder="请选择"  >
                            <?php if(is_array($typeList)): foreach($typeList as $key=>$vo): ?><option type_id="<?php echo ($vo["id"]); ?>"><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select id="type2" name="type2" class="form-control" required="required" placeholder="请选择" >
                            <?php if(is_array($typeList2)): foreach($typeList2 as $key=>$vo): ?><option><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select id="shop" name="shop" class="form-control" required="required" placeholder="请选择" >
                            <?php if(is_array($shopList)): foreach($shopList as $key=>$vo): ?><option><?php echo ($vo["shop_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>   
