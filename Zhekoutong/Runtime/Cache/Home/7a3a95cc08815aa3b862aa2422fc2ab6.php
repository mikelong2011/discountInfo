            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <ul class="list-group">
                        ...
                        <?php if(is_array($distList)): foreach($distList as $key=>$vo): ?><a href="/tp3/index.php/home/area/gettown/dist_id/<?php echo ($vo["id"]); ?>/dist_name/<?php echo (urlencode($vo["shortname"])); ?>">
