...
<html>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form method="post" action="__URL__/member_update" >
                <div class="space_sm" style="font-size:20px">
                    <?php echo $_SESSION['member_name'] ?>
                </div>
                <div class="input-group">
                    <span class="input-group-addon"  >你的呢称:</span>
                    <input type="text" name="nic_name" value="{$member_data['nic_name']}" maxlength="20" class="form-control"  placeholder="取个屌一点的外号吧" />
                </div>   
                <div class="input-group">
                    <span class="input-group-addon"  >个性签名:</span>
                    <input type="text" name="desc" value="{$member_data['desc']}" maxlength="20" class="form-control" required="required" placeholder="没有个性不签名" />
                </div> 
                <div class="space_sm">联系方式</div>
                <div class="input-group">
                    <span class="input-group-addon" >QQ  号码:</span>
                    <input type="text" name="qq" value="{$member_data['qq']}"　 maxlength="20" class="form-control" required="required" />
                </div>
                <div class="input-group">
                    <span class="input-group-addon"  >微信帐号:</span>
                    <input type="text" name="weixin"  value="{$member_data['weixin']}"  maxlength="20" class="form-control" required="required" />
                </div>
              
                <div class="input-group">
                    <span class="input-group-addon"  >手机号码:</span>
                    <input type="text" name="mobile" value="{$member_data['mobile']}"   maxlength="20" class="form-control" required="required" placeholder="中国大陆手机号码" />
                </div>
                <div class="input-group">
                    <span class="input-group-addon"  >电子邮箱:</span>
                    <input type="text" name="email"  value="{$member_data['email']}"  maxlength="20" class="form-control" required="required" placeholder="这个可以用来取得密码" />
                </div>
                <div class="input-group">
