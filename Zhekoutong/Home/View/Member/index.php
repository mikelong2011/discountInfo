        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <div class="row" style="margin: 10px">
                    <form id="photo_form" action="__URL__/upload_photo" method="POST" enctype="multipart/form-data">
                        <div class="col-xs-6">
                ...
                <div class="row bar">
                    ...
                    <a href="__APP__/admin/brand/index/member/<?php echo $_SESSION['member_id'] ?>">
                        <div class="col-xs-2">
                            <span class="glyphicon glyphicon-chevron-right"></span>
                        </div>
                    </a>
                ...
                <div class="row bar">
                    ...
                    <a href="__APP__/admin/shop/index/member/<?php echo $_SESSION['member_id'] ?>">
                        <div class="col-xs-2">
                            <span class="glyphicon glyphicon-chevron-right"></span>
                        </div>
                    </a>
                ...
                <div class="row bar">
                    ...
                    <a href="__APP__/home/goods/index/member/<?php echo $_SESSION['member_id'] ?>">
                        <div class="col-xs-2">
                            <span class="glyphicon glyphicon-chevron-right"></span>
                        </div>
                    </a>
